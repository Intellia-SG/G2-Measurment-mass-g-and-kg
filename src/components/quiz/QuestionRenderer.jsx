...
import MassVisual from '../shared/MassVisual.jsx';
...
export default function QuestionRenderer({
  ...
  const categoryTag = category || 'MASS & WEIGHT';
    ...
    <div className="qr-wrap glass-card anim-slide-up">
      ...
      {visual && visualData && (
        <div className="qr-visual">
          <MassVisual type={visual} data={visualData} compact={true} />
        </div>
      )}
      ...
      {/* Bottom Action Row: Hint Button + Prev + Next */}
