    ...
    return (
      <div className="play-done-wrap">
        <div className="play-done-card glass-card anim-bounce-in">
          ...
          <button className="btn btn-primary btn-lg play-done-cta" onClick={() => dispatch({ type: 'SET_PHASE', payload: 'reflect' })}>
            🌟 Go to Reflect Phase
          </button>
        </div>
      </div>
    ...
    return (
      <div className="play-map-wrap">
        <div className="play-map-card glass-card">
          <h2 className="play-map-title subheadline">🗺️ Mass Worlds Kingdom</h2>
          <p className="body-text" style={{ color: 'var(--text-secondary)', textAlign: 'center' }}>
            {isAllDone ? (
              <strong style={{ color: 'var(--gold)' }}>All 10 Mass Worlds Complete!</strong>
            ) : (
